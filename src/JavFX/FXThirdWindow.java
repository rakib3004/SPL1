...
public class FXThirdWindow extends Application {
    ...
    public void start(Stage primaryStage) {
     ...
     //   Image image = new Image("Images"+ File.separator +"libraryBackground2.jpg");
        ...
        MenuItem system_analysis = new MenuItem("System Analysis");
        system_analysis.setOnAction(new EventHandler<ActionEvent>() {
            @Override public void handle(ActionEvent e) {
        ...
        menu5.getItems().addAll(readingRoom1,libraryDesk1,
                ...
                testingSetView,bookInformationView,system_analysis);
